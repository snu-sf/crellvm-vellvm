...
induction n.
replace (digits2_Pnat n~1) with (S (digits2_Pnat n)); try reflexivity.

rewrite Zpos_xI, 2!Hp.
omega.
replace (digits2_Pnat n~0) with (S (digits2_Pnat n)); try reflexivity.
...
rewrite (Z_quot_rem_eq n (beta ^ e)).
