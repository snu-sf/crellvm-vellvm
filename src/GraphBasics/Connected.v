...
Inductive Connected : (@V_set A) -> (@A_set A) -> Type :=
...
Proof.
        ...
        red in |- *; intros; elim n; rewrite <- H; trivial.

        red in |- *; intros; elim n; apply (G_ina_inv2 _ _ X _ _ H).

        red in |- *; intros; elim n; apply (G_ina_inv1 _ _ X _ _ H).
...
Proof.
        ...
        elim n; apply (C_ina_inv2 _ _ co _ _ H8).

        elim n; apply (C_ina_inv1 _ _ co _ _ H8).
        ...
        fold (Union (@Arc A)) (@A_union A) in |- *; rewrite H6; rewrite e; rewrite H7.
        trivial.
        ...
        case (V_union_single_dec eq_a_dec _ _ _ n H); intros.
        rewrite <- e in H1;
        ...
        red in |- *; intros; elim n; apply (C_ina_inv2 _ _ co _ _ H7).

        red in |- *; intros; elim n; apply (C_ina_inv1 _ _ co _ _ H7).
        ...
        red in |- *; intros Hi; elim H2; inversion Hi; trivial.
